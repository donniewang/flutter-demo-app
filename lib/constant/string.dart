class Strings {
    ...
    static const String HOME = "拍卖大厅";
    static const String ORDER = "我已出价";
    static const String TODO = "待办";
    static const String MINE = "我的";


    static const String SPLASH = "闪屏";


    static const String TOKEN_KEY = "zdp-token";
    static const String TOKEN_HEADER = "Bearer ";
    ...
    static String LOGO = "汽车金融不良资产拍卖平台";

    static String SEND_VCODE = "获取验证码";

    static String TREATY = "同意资得拍《平台服务协议》《隐私协议》";
